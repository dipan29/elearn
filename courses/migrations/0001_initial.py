    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.FloatField(help_text='Price of the course, to be entered set Currency', validators=[django.core.validators.MinValueValidator(9.99)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', ckeditor.fields.RichTextField(default='Follow the lesson', help_text='Enter the entire lesson outflow just like you would in a word document')),
                ...
                ('video', embed_video.fields.EmbedVideoField(blank=True, help_text='Vimeo Video is preffered since it ensure video data protection', max_length=500)),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='courses.MasterCategory'),
        ),
    ]
